...
const CoursNew = () => {
  ...
  const years = [
    { id: "year3", label: "3ème année", color: "#4CAF50" },
    { id: "year4", label: "4ème année", color: "#2196F3" },
    { id: "year5", label: "5ème année", color: "#FF9800" }
  ];
  ...
  const loadAllModules = async () => {
    ...
    try {
      ...
      for (const year of ["year3", "year4", "year5"]) {
        ...
        if (snapshot.exists()) {
          modulesData[year] = Object.keys(snapshot.val());
        }
      }
  ...
  const loadResources = async () => {
    ...
    try {
      const resourcesRef = ref(database, `resources/cours/${selectedYear}/${selectedModule}`);
      ...
      <section className="cours-container">
        <header className="cours-header">
          <div className="cours-title-section">
            ...
            <div>
              <h1 className="cours-title">{currentYear?.label}</h1>
